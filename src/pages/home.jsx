            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#0031A7]/30 to-[#44b8f3]/20 rounded-3xl p-8 backdrop-blur-sm border border-white/10">
                <FloatingElement duration={4}>
                  <div className="w-48 h-48 mx-auto mb-6 bg-white/5 rounded-full flex items-center justify-center">
                    <School className="w-24 h-24 text-[#44b8f3]" />
                  </div>
                </FloatingElement>
          ...
          >
            <FloatingElement duration={4}>
              <div className="w-20 h-20 mx-auto mb-6 bg-white/5 rounded-full flex items-center justify-center border border-white/10">
                <Mail className="w-10 h-10 text-[#44b8f3]" />
              </div>
            </FloatingElement>
          ...
          {submitted ? (
            ...
            >
              ...
              <FloatingElement duration={3}>
                <Rocket className="w-24 h-24 mx-auto text-[#0031A7]" />
              </FloatingElement>
            </motion.div>
          ) : (
              <motion.form
